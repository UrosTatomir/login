...
<?php  include_once "functions/db.php" ?>
	...
	<div class="jumbotron">
		<h5 class="text-right">Download page<?php
          ...
          <?php
              ...
              $sql = "SELECT countsdownload FROM user_count WHERE id = 1";
              ...
              if(row_count($result) == 1){
                     ...
                     $row = fetch_array($result);
                      ...
                      $current_count = $row['countsdownload'];

                      $new_count = $current_count + 1;

                      $sql = " UPDATE user_count SET countsdownload = '$new_count' ";
